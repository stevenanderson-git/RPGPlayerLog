...
public class MainGUI extends JFrame {
    ...
    private void buildContentGridBag() {
        ...
        // rightTabbedPane.addTab("Lorem Ip", fillTextArea(rightTextArea));
        // rightScrollPane.setViewportView(rightTabbedPane);
        // rightScrollPane.setViewportBorder(BorderFactory.createCompoundBorder(BorderFactory.createRaisedBevelBorder(),
        //         BorderFactory.createLoweredBevelBorder()));
    ...
    private JTextArea fillTextArea(JTextArea textArea) {
        ...
        // https: //
        // stackoverflow.com/questions/5880169/loading-a-text-file-into-a-textarea
        try {
